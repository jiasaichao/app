...
/***/ function(module, exports, __webpack_require__) {
	...
	var notFound_1 = __webpack_require__(131);
	//import Modeules from './controller/index';
	//import {BaseStore} from './redux/store/BaseStore';
	//import URL_CONFIG from './routersConfig';
	//const store = BaseStore();
	var store_1 = __webpack_require__(132);
	//const history = syncHistoryWithStore(hashHistory, store);
	//store.subscribe(()=>{console.log('改变了')})
	var appRootComponent = (React.createElement(react_redux_1.Provider, {store: store_1.store}, React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Route, {path: "/", component: app_1.default}, React.createElement(react_router_1.IndexRoute, {component: index_1.default})), React.createElement(react_router_1.Route, {path: "*", component: notFound_1.default}))));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makeStateWithLocation = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var index_1 = __webpack_require__(90);
	var Index = React.createClass({
	    render: function () {
	        return (React.createElement(index_1.NavBar, {title: "标题"}));
	    }
	});
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path="../../typings/browser.d.ts" />
	var common_1 = __webpack_require__(92);
	var public_1 = __webpack_require__(94);
	    ...
	    function Table() {
	        ...
	        */
	        this.renderPage = function () {
	            console.log(SL.czjz);
	            return (React.createElement("div", {style: SL.create(SL.czjz).merge({ height: 45 }).o}, React.createElement(public_1.Placeholder.Full, null), React.createElement("ul", {style: SL.create(SL.czjz).o})));
	        };
	    }
	...
	(function (Placeholder) {
	    ...
	    var Statusbar = (function (_super) {
	        ...
	        Statusbar.prototype.render = function () {
	            var styles = {
	                style: common_1.Global.styles.create({ display: 'flex', flex: 1, height: '.4rem', background: '#0cbaa0' }).merge(this.props.style)
	            };
	            if (this.props.background) {
	                styles.style.merge({ background: this.props.background });
	            }
	            return (React.createElement("div", {style: styles.style.o}));
	        };
	        return Statusbar;
	    }(React.Component));
	    Placeholder.Statusbar = Statusbar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarItems = (function (_super) {
	    ...
	    SidebarItems.prototype.render = function () {
	        ...
	        return React.createElement("li", {style: { borderBottom: "1px solid #3D4957" }}, i);
	    };
	...
	(function (Alert) {
	    ...
	    var Close = (function (_super) {
	        ...
	        Close.prototype.render = function () {
	            ...
	            return (React.createElement(Base, {style: styles.root.o, type: this.props.type}, this.props.children));
	        };
	        return Close;
	    }(React.Component));
	    Alert.Close = Close;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavBar = (function (_super) {
	    ...
	    NavBar.prototype.render = function () {
	        ...
	        var items = [1, 2, 3, 4].map(function (v) {
	            return (React.createElement("div", {key: v}, v));
	        });
	        return (React.createElement("div", null, React.createElement(public_1.Placeholder.Statusbar, null), React.createElement(ReactCSSTransitionGroup, {transitionName: "example", transitionAppear: true, transitionAppearTimeout: 500, transitionEnterTimeout: 500, transitionLeaveTimeout: 500}, items), React.createElement("div", {style: styles.root.o}, React.createElement("div", {style: styles.left.o}, " ", React.createElement(button_1.Button.Base, {lable: '返回', leftIcon: 'chevron-left'})), React.createElement("h1", {style: styles.h1.o}, this.props.title))));
	    };
	    return NavBar;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**按钮*/
	var common_1 = __webpack_require__(92);
	var Tappable = __webpack_require__(101);
	var Button;
	(function (Button) {
	    var SL = common_1.Global.styles;
	    /**
	    ...
	    var Base = (function (_super) {
	        ...
	        Base.prototype.render = function () {
	            ...
	            if (this.props.leftIcon) {
	                leftIcon = React.createElement("span", {style: { fontSize: ".24rem", color: "#fff" }, className: 'icon-' + this.props.leftIcon});
	            }
	            if (this.props.rightIcon) {
	                rightIcon = React.createElement("span", {style: { fontSize: ".24rem", color: "#fff" }, className: 'icon-' + this.props.rightIcon});
	            }
	            return (React.createElement(Tappable, {style: styles.root.o, component: 'a'}, leftIcon, React.createElement("span", {style: { fontSize: '.28rem' }}, this.props.lable), rightIcon));
	        };
	        return Base;
	    }(React.Component));
	    Button.Base = Base;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TappableMixin = __webpack_require__(102);
	var PinchableMixin = __webpack_require__(104);
	var getComponent = __webpack_require__(105);
	var touchStyles = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroupChild = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function flattenSingleChildIntoContext(traverseContext, child, name, selfDebugID) {
	  ...
	  if (traverseContext && typeof traverseContext === 'object') {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var ReactComponentTreeDevtool = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_router_redux_1 = __webpack_require__(133);
	var react_router_1 = __webpack_require__(26);
	var redux_thunk_1 = __webpack_require__(138);
	var defaultState = {
	    sidebar: {
	        active: 1,
	        parent: [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sync = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var react_router_redux_1 = __webpack_require__(133);
	var sidebarReducer_1 = __webpack_require__(140);
	var routerReducer_1 = __webpack_require__(141);
	/**
	 * 合并reducers
	 */
