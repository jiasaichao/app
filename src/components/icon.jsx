...
export function Icon({ color, width, height, background, name }) {
    return (
        <svg dangerouslySetInnerHTML={{__html:icons[name].content}} width={width} height={height} fill={color} style={{ background }} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xmlSpace="preserve">
        </svg>
    );
}